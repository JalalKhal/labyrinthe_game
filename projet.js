...
function messageDimension() {//  Insère dans la balise <p id="dimension"> les dimensions et la largeur du labyrinthe.
	
    var message = document.getElementById("dimension");
	

    message.innerHTML ="La largeur du labyrinthe est: " +document.getElementsByTagName("table")[0].offsetWidth +
      " et la hauteur est: " + document.getElementsByTagName("table")[0].offsetHeight;
